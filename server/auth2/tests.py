...
class SDUserTestCases(TestCase):
    ...
    def test_signup(self):
        request = self.factory.post('/api/auth/signup/', {"nickname": "TesterA", "name": "Tester", "picture": "picA",
    ...
    def test_reassign_RO_to_BU(self):
        request = self.factory.post('/api/auth/reassign/', {"user_email": "B@mail.com", "role": "BU"}, content_type='application/json')
    ...
    def test_reassign_BU_to_RO(self):
        request = self.factory.post('/api/auth/reassign/',
